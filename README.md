...
- [ ] **luffy/verl/tests/model/test_transformer.py:50** - attention_mask)  # sgm): we can construct the position_ids_rmpad here
- [ ] **luffy/verl/tests/model/test_transformer.py:111** - attention_mask)  # sgm): we can construct the position_ids_rmpad here
- [ ] **luffy/verl/tests/model/test_transformers_ulysses.py:34** - sgm): add more models for test
- [ ] **luffy/verl/tests/model/test_transformers_ulysses.py:81** - attention_mask)  # sgm): we can construct the position_ids_rmpad here
- [ ] **luffy/verl/tests/model/test_transformers_ulysses.py:159** - attention_mask)  # sgm): we can construct the position_ids_rmpad here
...
- [ ] **luffy/verl/verl/mix_src/mix_trainer_acc_rebatch.py:592** - checkpoint_folder = self.config.trainer.default_local_dir  #  check path
- [ ] **luffy/verl/verl/mix_src/mix_trainer_acc_rebatch.py:628** - from remote not implemented yet
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:43** - TODO item
...
- [ ] **luffy/verl/verl/models/llama/megatron/modeling_llama_megatron.py:37** - TODO item
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_3_1/llm_engine_sp.py:101** - self.model_config = model_config  #  currently is hfconfig
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/llm_engine_sp.py:130** - self.model_config = model_config  #  currently is hfconfig
...
- [ ] **luffy/verl/verl/trainer/ppo/ray_trainer.py:632** - checkpoint_folder = self.config.trainer.default_local_dir  #  check path
...
- [ ] **luffy/verl/verl/workers/rollout/vllm_rollout/vllm_rollout.py:43** - TODO item
